                ...
                dir('terraform') {
                    script {
                        ...
                        echo "Deploying to EC2 IP: ${ec2Ip}" 
                            ...
                            sh """
                            # 1. Ensure the key generated by Terraform has correct permissions
                        chmod 400 Task-app-key.pem
                        
                        # 2. Connect and Execute commands on the remote EC2
                        # We use 'ec2-user' as defined in your Amazon Linux AMI
